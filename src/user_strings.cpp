...
user_string_def common_strings[] = {
	...
	{STR_GUI_ERROR_PREFIX, "SheepShear error:\n%s"},
	{STR_ERROR_ALERT_TITLE, "SheepShear Error"},
	{STR_SHELL_WARNING_PREFIX, "WARNING: %s\n"},
	{STR_GUI_WARNING_PREFIX, "SheepShear warning:\n%s"},
	{STR_WARNING_ALERT_TITLE, "SheepShear Warning"},
	{STR_NOTICE_ALERT_TITLE, "SheepShear Notice"},
	{STR_ABOUT_TITLE, "About SheepShear"},
	{STR_OK_BUTTON, "OK"},
	...
	{STR_ROM_SIZE_ERR, "Invalid ROM file size. SheepShear requires a 4MB PCI PowerMac ROM."},
	{STR_UNSUPPORTED_ROM_TYPE_ERR, "Unsupported ROM type."},
	{STR_POWER_INSTRUCTION_ERR, "Your Mac program is using POWER instructions which are not supported by SheepShear.\n(pc %p, sp %p, opcode %08lx)"},
	...
	{STR_CANNOT_UNMOUNT_WARN, "The volume '%s' could not be unmounted. SheepShear will not use it."},
	{STR_CREATE_VOLUME_WARN, "Cannot create hardfile (%s)."},

	{STR_PREFS_TITLE, "SheepShear Settings"},
	{STR_PREFS_MENU, "Settings"},
	{STR_PREFS_ITEM_ABOUT, "About SheepShear" ELLIPSIS},
	{STR_PREFS_ITEM_START, "Start SheepShear"},
	{STR_PREFS_ITEM_ZAP_PRAM, "Zap PRAM File"},
	{STR_PREFS_ITEM_QUIT, "Quit SheepShear"},
	...
	{STR_WINDOW_TITLE, "SheepShear"},
	{STR_WINDOW_TITLE_FROZEN, "SheepShear *** FROZEN ***"},
	{STR_WINDOW_MENU, "SheepShear"},
	{STR_WINDOW_ITEM_ABOUT, "About SheepShear" ELLIPSIS},
